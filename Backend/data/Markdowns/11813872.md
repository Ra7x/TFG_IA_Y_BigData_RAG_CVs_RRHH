...
- Deep expertise in designing,developing, implementing and running mission critical systems involving OLTP,OLAP and HTAP workloads Extensive experience in building and deploying large Deep expertise in Oracle Exadata, Amazon Redshift, scale applications in cloud environment(AWS) SQL,Python,Java,Apache Ignite, AWS and related technologies. Deep expertise in advanced data modeling, data Basic Experience in Data Science related technologies e.g. Pandas, Matplotlib management and data governance etc. Passionate IT leader to build and lead a very strong Agile development methodologies e.g. JIRA team to build,deliver and support world-class Quick leaner and ability to solve complex business problems product(IBOR) using innovative technology An active member in multiple working groups to establish data strategy, data Hands-on development/business manager and governance, data quality and enterprise data architecture (e.g. Business principal solution architect Architecture ,Data Architecture, Data Quality working groups) Deep expertise in front office, middle office and Financial instruments valuation and exposure experience back office related business workflows in the IT Thought leader and key note speaker at in-memory compute summit in 2017 financial industry. and 2018 Deep expertise in financial instruments modeling including complex derivative products Portfolio and investment management 

Experience 01/2003 to Current VP, Principal Company Name ï¼​ City , State 
...
- Designed,developed,implemented and supporting operational historical data store (ODS) application(>60TB) using Oracle Exadata. The ODS maintains historical positions,exposure and performance data. My team also migrated data and built a data pipeline from Oracle to 
...
Senior Software Engineer Company Name ï¼​ City , State 
...
Database Developer Company Name ï¼​ City , State 
...
Oracle Developer Company Name ï¼​ City , State 
...
- _Shares Management System_ 

- _Asset Management System_ 

- _Payroll and Personnel Information System_ 

- _Accounting Management System_ 

- _Vehicle Management System Inventory Management System (IMS)_ 

## Education and Training 

09/1998 

Master of Science : Computer Science And Programming QAU ï¼​ City 01/2008 

CFA Level 1 CFA Institute ï¼​ City 

Some College (No Degree) : Python For Finance Udemy Courses Certifications 

Certified AWS Certified Cloud Practitioner - 2020 RLF(Leadership for Life) graduate, Babson College 2018 Oracle Certified Professional 2001 
...
Https://www.imcsummit.org/2018/us/session/optimized-memory-ibor-architecture-cloud-environment-using-apache-ignite Https://www.imcsummit.org/2017/us/sessions/implementation-investment-book-record-ibor-using-apache-ignitegridgain 
