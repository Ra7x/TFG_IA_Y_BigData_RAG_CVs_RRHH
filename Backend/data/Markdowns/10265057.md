...
B.S : Electrical and Computer Engineering , Dec. 2011 GPA: GPA: 3.2/4.0 Electrical and Computer Engineering GPA: 3.2/4.0 Thesis The Design and Evaluation of a 5.8 GHz Laptop-Based Radar System Publication Â· Innovative laptop radar design to operate in both FMCW and CW mode Â· Doppler shift (DTI), ranging (RTI), and SAR measurement capability Â· Operate in ISM frequency band with +13dBm transmitting power Â· Data acquisition and signal processing using Matlab 
